...
export default function LoginPage() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4" style={{ background: '#ffffff' }}>
      <div className="w-full max-w-md text-center">
        <h1 className="font-display text-xl tracking-[0.15em] uppercase mb-2 text-[#535353]">Jeff Oliver Photography</h1>
        <Divider />
