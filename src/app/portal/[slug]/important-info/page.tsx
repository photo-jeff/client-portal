      ...
      <div className="space-y-10">
        ...
        <section className="bg-white border border-[#e0ddd8] p-8 space-y-5">
          ...
          <div>
            ...
            <p className="text-sm text-[#888] mt-3 italic">
              For example: 2:00pm ceremony, leaving at 1:30pm → we arrive at 11:30am, dress on by 12:30pm.
            </p>
            <p className="text-sm text-[#888] mt-3">
              Your personalised timings will appear here once you've completed your questionnaire.
            </p>
          </div>
        ...
        <section className="bg-white border border-[#e0ddd8] p-8">
          ...
          <p className="text-sm text-[#888] mt-3 leading-relaxed">
            Use the <Link href={`/portal/${slug}/shot-list`} className="underline hover:text-[#1a1a1a]">Shot List</Link> section of your portal to build your list and submit it to us. Please aim to have it done <strong>2–3 weeks before your wedding</strong>.
          </p>
        </section>
        ...
        <section className="bg-white border border-[#e0ddd8] p-8">
          ...
          <p className="text-sm text-[#888] leading-relaxed">
            Your full gallery is typically ready within <strong>8 weeks</strong> of your wedding day. We'll share some early preview shots on Instagram and Facebook before then — tag us so we can share yours too.
          </p>
          <p className="text-sm text-[#888] mt-3 leading-relaxed">
