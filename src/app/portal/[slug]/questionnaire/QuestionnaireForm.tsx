    ...
    <div>
      ...
      <div className="bg-white border border-[#e0ddd8] p-8 space-y-8">
        ...
        {step === 0 && (
          <>
            <div>
              <p className="text-xs tracking-[0.12em] uppercase text-[#888] mb-1">Morning preparations</p>
              <p className="text-sm text-[#aaa] mb-5">We'll be with you from the start — help us know where to go.</p>
            ...
            <div className="space-y-2">
              <label className="block text-xs tracking-[0.1em] uppercase text-[#888] font-medium">
                Are you having a first look before the ceremony?
              </label>
              <p className="text-xs text-[#aaa]">A first look is a private moment together before you walk down the aisle — it means we can get all your couple portraits done before the ceremony.</p>
            ...
            <div>
              <p className="text-xs tracking-[0.12em] uppercase text-[#888] mb-1">Ceremony</p>
            ...
            {timings && (
              <div className="bg-[#faf9f7] border border-[#e0ddd8] p-5 space-y-3">
                <p className="text-xs tracking-[0.1em] uppercase text-[#888] flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-xs text-[#aaa] uppercase tracking-widest">{partner1} in dress by</p>
            ...
            <div>
              <p className="text-xs tracking-[0.12em] uppercase text-[#888] mb-1">Reception</p>
              <div className="space-y-5 mt-4">
                <Input
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-[#aaa]">It's a long day and we want to be at our best for your evening coverage — most venues are happy to accommodate us.</p>
        ...
        {step === 1 && (
          <>
            <div>
              <p className="text-xs tracking-[0.12em] uppercase text-[#888] mb-1">The personal touches</p>
              <p className="text-sm text-[#aaa] mb-6">The little details that make your day yours.</p>
            ...
            <div>
              <p className="text-xs tracking-[0.12em] uppercase text-[#888] mb-1">Sharing your day</p>
              <p className="text-sm text-[#aaa] mb-6">Just so we can loop you in when we share your photos online.</p>
              <div className="space-y-5">
                <Input
          ...
          <>
            {daysUntil !== null && daysUntil > 60 ? (
              <div className="bg-[#faf9f7] border border-[#e0ddd8] p-5 text-center space-y-2">
                ...
                <p className="text-xs text-[#aaa]">We'll remind you to come back about 8 weeks before your wedding.</p>
              </div>
            ) : (
