...
export function Button({ variant = 'outline', size = 'md', className = '', children, ...props }: ButtonProps) {
  ...
  const variants = {
    outline: 'border border-[#1a1a1a] text-[#1a1a1a] bg-transparent hover:bg-[#1a1a1a] hover:text-white',
    filled: 'border border-[#1a1a1a] bg-[#1a1a1a] text-white hover:opacity-80',
  }
  return (
