...
export function Button({ variant = 'outline', size = 'md', className = '', children, ...props }: ButtonProps) {
  const base = 'inline-flex items-center justify-center tracking-[0.15em] uppercase font-sans font-medium transition-all duration-200 disabled:opacity-40 cursor-pointer rounded-lg'
